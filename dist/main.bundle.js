(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["molgenis-api-client"] = factory();
	else
		root["molgenis-api-client"] = factory();
})(this, function() {
...
function callApi(server, uri, method, token) {
  ...
  if (token) {
    settings.headers = (0, _extends3.default)({}, jsonContentHeaders, { 'x-molgenis-token': token });
  } else {
    settings.credentials = 'same-origin';
  }
...
function get(server, uri, token) {
  return callApi(server, uri, 'get', token);
}

function login(username, password) {
  return (0, _isomorphicFetch2.default)('/api/v1/login', {
    method: 'post',
    headers: jsonContentHeaders,
...
function logout(server, token) {
  return (0, _isomorphicFetch2.default)(server.apiUrl + 'v1/logout', {
    method: 'get',
    headers: (0, _extends3.default)({}, jsonContentHeaders, { 'x-molgenis-token': token })
  });
}

exports.default = { login: login, logout: logout, get: get, callApi: callApi };
